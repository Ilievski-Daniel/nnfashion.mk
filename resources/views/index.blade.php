...
<body>
    ...
    <div class="wrapper">
        ...
        <main class="main-content">
                                            ...
                                            <div class="col-lg-5">
                                                <div class="slider-content">
                                                    <div class="content">
                                                        ...
                                                        <div class="title-box">
                                                            <h2 class="title"><span
                                                                    class="font-weight-400">Exclusive<br> </span>New
                                                                Shoes</h2>
                                                        </div>
                                                        <div class="btn-box">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="section-title text-center">
                                <h3 class="title">Нови артикли</h3>
                                <div class="desc">
                                    <p>Секоја недела, во нашиот бутик се додаваат нови артикли.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-sm-6 col-lg-3">
                            ...
                            <div class="product-item">
                                <div class="inner-content">
                                    <div class="product-thumb">
                                        <a href="single-product.html">
                                            <img src="assets/img/shop/2.webp" width="270" height="274"
                                                alt="Image-HasTech">
                                        </a>
                                        <div class="product-action">
                                            <a class="btn-product-wishlist" href="shop-wishlist.html"><i
                            ...
                            <div class="product-item">
                                <div class="inner-content">
                                    ...
                                    <div class="product-info">
                                        ...
                                        <h4 class="title"><a href="single-product.html">Rexpo Womens shoes</a>
                                        </h4>
                                        <div class="prices">
                            ...
                            <div class="product-item">
                                <div class="inner-content">
                                    ...
                                    <div class="product-info">
                                        ...
                                        <h4 class="title"><a href="single-product.html">Hollister V-Neck
                                                Knit</a></h4>
                                        <div class="prices">
                            ...
                            <div class="product-item">
                                <div class="inner-content">
                                    ...
                                    <div class="product-info">
                                        ...
                                        <h4 class="title"><a href="single-product.html">New Womens High
                                                Hills</a></h4>
                                        <div class="prices">
                            ...
                            <div class="product-item">
                                <div class="inner-content">
                                    ...
                                    <div class="product-info">
                                        ...
                                        <h4 class="title"><a href="single-product.html">Simple Fabric Shoe</a>
                                        </h4>
                                        <div class="prices">
                        ...
                        <div class="col-sm-6 col-lg-3">
                            ...
                            <div class="product-item">
                                <div class="inner-content">
                                    <div class="product-thumb">
                                        <a href="single-product.html">
                                            <img src="assets/img/shop/8.webp" width="270" height="274"
                                                alt="Image-HasTech">
                                        </a>
                                        <div class="product-flag">
                                            <ul>
                                    ...
                                    <div class="product-info">
                                        ...
                                        <h4 class="title"><a href="single-product.html">exclusive mens
                                                shoe</a></h4>
                                        <div class="prices">
                                            <span class="price-old">$300</span>
                                            <span class="sep">-</span>
            ...
            <section class="product-area product-category-area mb-3">
                            ...
                            <div class="product-category">
                                <div class="inner-content">
                                    <div class="product-category-content">
                                        <div class="content">
                                            <h4 class="sub-title">Нови модели</h4>
                                            <h3 class="title"><a href="shop.html">Mашки</a></h3>
                                        </div>
                                    </div>
                                    <div class="product-category-thumb" data-bg-img="assets/img/shop/category/1.webp">
                                    </div>
                                    <a class="banner-link-overlay" href="shop.html"></a>
                                </div>
                            </div>
                            ...
                            <div class="product-category mt-xs-30">
                                <div class="inner-content">
                                    <div class="product-category-content">
                                        <div class="content">
                                            <h4 class="sub-title">Нови модели</h4>
                                            <h3 class="title"><a href="shop.html">Женски</a></h3>
                                        </div>
                                    </div>
                                    <div class="product-category-thumb" data-bg-img="assets/img/shop/category/2.webp">
                                    </div>
                                    <a class="banner-link-overlay" href="shop.html"></a>
                                </div>
                            </div>
                            ...
                            <div class="product-category">
                                <div class="inner-content">
                                    <div class="product-category-content">
                                        <div class="content">
                                            <h4 class="sub-title">Нови модели</h4>
                                            <h3 class="title"><a href="shop.html">Детски</a></h3>
                                        </div>
                                    </div>
                                    <div class="product-category-thumb" data-bg-img="assets/img/shop/category/1.webp">
                                    </div>
                            ...
                            <div class="product-category mt-xs-30">
                                <div class="inner-content">
                                    <div class="product-category-content">
                                        <div class="content">
                                            <h4 class="sub-title">Нови модели</h4>
                                            <h3 class="title"><a href="shop.html">Бебешки</a></h3>
                                        </div>
                                    </div>
                                    <div class="product-category-thumb" data-bg-img="assets/img/shop/category/2.webp">
                                    </div>
                ...
                <div class="row">
                    <div class="col-md-7 col-lg-6">
                        <p class="copyright">© {{ date('M, Y') }} NNfashion. Made with <i
                                class="fa fa-heart"></i> by <a target="_blank" href="https://webmak.mk/">WebMak.</a>
                        </p>
                    </div>
    ...
    <div class="aside-cart-wrapper offcanvas offcanvas-end" tabindex="-1" id="AsideOffcanvasCart"
        ...
        <div class="offcanvas-header">
            ...
            <button class="btn-aside-cart-close" data-bs-dismiss="offcanvas" aria-label="Close">Продукти <i
        ...
        <div class="offcanvas-body">
            ...
            <a class="btn-theme" data-margin-bottom="10" href="shop-cart.html">Кошничка</a>
            <a class="btn-theme" href="/checkout">Нарачај</a>
        </div>
    </div>
    <!--== End Aside Cart Menu ==-->
    ...
    <div class="off-canvas-wrapper offcanvas offcanvas-start" tabindex="-1" id="AsideOffcanvasMenu"
        ...
        <div class="offcanvas-body">
            <div class="info-items">
                <ul>
                    <li class="number"><a href="tel:078209101"><i class="fa fa-phone"></i>078/209-101</a>
                    </li>
