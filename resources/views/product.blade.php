        ...
        <main class="main-content">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-header-content">
                                <h2 class="title" data-aos="fade-down" data-aos-duration="1000">Product Details
                                </h2>
            ...
            <section class="product-area product-single-area">
                <div class="container">
                                ...
                                <div class="row">
                                    <div class="col-xl-6">
                                        ...
                                        <div class="product-single-thumb">
                                            <div
                                                class="swiper-container single-product-thumb single-product-thumb-slider">
                    ...
                    <section class="product-area product-best-seller-area mt-2">
                        <div class="container">
                            <div class="row">
                                <div class="col-12">
