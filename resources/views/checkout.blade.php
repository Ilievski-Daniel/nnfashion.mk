        ...
        <div class="row">
          <div class="col-lg-6">
            ...
            <div class="checkout-billing-details-wrap">
              <h2 class="title">Податоци за достава</h2>
                  ...
                  <div id="PaymentMethodAccordion">
                    <div class="card">
                      <div class="card-header" id="check_payments">
                        <h5 class="title" data-bs-toggle="collapse" data-bs-target="#itemOne" aria-controls="itemOne" aria-expanded="true">Плаќање при достава на адреса</h5>
                      </div>
                    </div>
                  </div>
