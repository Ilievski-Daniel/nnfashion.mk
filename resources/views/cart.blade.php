                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-header-content">
                                <h2 class="title" data-aos="fade-down" data-aos-duration="1000">Кошничка</h2>
                                <nav class="breadcrumb-area" data-aos="fade-down" data-aos-duration="1200">
                                    <ul class="breadcrumb">
                                        <li><a href="/shop">Продавница</a></li>
                    ...
                    <div class="row row-gutter-50">
                        <div class="col-md-12 col-lg-4">
                            <div class="shipping-form-cart-totals">
                                                ...
                                                <td>
                                                    <ul class="shipping-list">
                                                        <li class="radio">
                                                            ...
                                                            <label for="radio2"><span></span> Бесплатна достава</label>
                                                        </li>
                                                        <li class="radio">
                                                            <input type="radio" name="shipping" id="radio3">
                                                            <label for="radio3"><span></span> Подигни од адреса</label>
                                                        </li>
                                                    </ul>
                                                </td>
                                            </tr>
                                ...
                                <a class="btn-theme btn-flat" href="/checkout">Наплата</a>
                            </div>
                        </div>
                    </div>
                </div>
